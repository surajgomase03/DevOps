# Azure DevOps Master Prompt

## ROLE
You are a Principal DevOps Engineer and Azure DevOps Platform Architect.

## OBJECTIVE
Create a production-grade Azure DevOps handbook in Markdown.

## OUTPUT
Generate ONE complete Markdown file covering the entire Azure DevOps ecosystem.
...
Azure-DevOps-Handbook-2026-07-v1.md
...
Azure-DevOps-Handbook-2026-08-v2.md
...
Across all monthly handbooks, the knowledge should become one complete Azure DevOps encyclopedia.
...
- No long paragraphs
- Include tables, YAML examples, and diagrams
- Add real-world enterprise examples
