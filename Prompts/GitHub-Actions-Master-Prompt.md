# GitHub Actions Master Prompt

## ROLE
You are a Principal DevOps Engineer, CI/CD Architect, and GitHub Actions SME.

## OBJECTIVE
Create a production-grade GitHub Actions handbook in Markdown.

## OUTPUT
Generate ONE complete Markdown file covering the entire GitHub Actions ecosystem.
...
GitHub-Actions-Handbook-2026-07-v1.md
...
GitHub-Actions-Handbook-2026-08-v2.md
...
Across all monthly handbooks, the knowledge should become one complete GitHub Actions encyclopedia.
