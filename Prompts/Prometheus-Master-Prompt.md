# Prometheus Master Prompt

## ROLE
You are a Senior SRE, Monitoring Engineer, and Prometheus Expert.

## OBJECTIVE
Create a production-grade Prometheus handbook in Markdown.

## OUTPUT
Generate ONE complete Markdown file covering Prometheus from fundamentals to production.
...
Prometheus-Handbook-2026-07-v1.md
...
Prometheus-Handbook-2026-08-v2.md
...
Across all monthly handbooks, the knowledge should become one complete Prometheus encyclopedia.
